  ...
  //section2
    ...
    gsap.from('.line',{scrollTrigger:{trigger:'.section2',start:'top 110%',end:'+=800',scrub:2},drawSVG:'0% 0%'})
     gsap.to('.section-title',{
      scrollTrigger:{trigger:'.section2',start:'top 110%',end:'+=800',onEnter:()=>{
      let hackeffecttitle=['jh2"é1','ASCK876','2à9_KhYGbF','2ID0','OKDOK0_','é_&jdld']
    let titletl=gsap.timeline({scrollTrigger:{trigger:'.section-title',start:'top bottom'}
      ,repeat:-1,yoyo:true
    })
    let titletl2=gsap.timeline()
    ...
    titletl.add(titletl2)
      },onLeave:()=>{gsap.to('.section-title',{text:'Services',duration:1})}},
    })
