...
//hero-section-animation
  ...
  //section2
    ...
    //glitch-part
    let glitchback=['/src/glitch1.png','/src/glitch2.png','/src/glitch3.png','/src/glitch4.png',]
    let glitchtl=gsap.timeline({
        repeat:-1,yoyo:true
    })
    let glitchtl2=gsap.timeline()
    glitchback.forEach(back=>{
      glitchtl2.to('.confused-page',{
        backgroundImage:`url(${back})`,
        duration:0.4
      })
    })
    glitchtl.add(glitchtl2)
