...
let section2tl = gsap.timeline({
  scrollTrigger: {
    ...
    scrub: 1,
    scroller: "[data-scroll-container]" // احذفها لو ما تستخدم Locomotive
  }
});

ScrollTrigger.matchMedia({

  // شاشات كبيرة (أكبر من 800px)
  "(min-width:1025px)": function() {
    ...
    section2tl.from('.services', { opacity: 0, y: 20 });
  },

  // شاشات iPad (بين 500px و 800px)
  "(min-width: 501px) and (max-width: 1024px)": function() {
    

    section2tl.from('.pl', { drawSVG: '0% 0%' })
              
    section2tl.from('.services', { opacity: 0, y: 10 });
  },

  // شاشات صغيرة (500px وأقل)
  "(max-width: 500px)": function() {
    

    section2tl.from('.FF', { drawSVG: '0% 0%' });
    section2tl.from('.services', { opacity: 0, y: 30 });
  }
});
