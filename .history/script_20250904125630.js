...
confused.addEventListener('click',e=>{
   ...
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch2.png')",duration:0.1,repeat:2
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch2.png')",duration:0.1,repeat:2
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch3.png')",duration:0.1,repeat:2
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch4.png')",duration:0.1,repeat:2
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch1.png')",duration:0.1,repeat:2
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch2.png')",duration:0.1,repeat:2
   })
