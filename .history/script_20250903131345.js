  ...
  //section2
    ...
    serinfos.forEach((serv)=>{
      serv.addEventListener('click',e=>{
        ...
        else if(i===serv&& serv.style.gridTemplateRows==='1fr 4fr'&&serv.querySelector('p').style.display==='block'){
           serv.querySelector('p').style.display='none'
           serv.style.gridTemplateRows='1fr'
        }else if(serv.querySelector('p').style.display==='none'&&serv.style.gridTemplateRows==='1fr'){
