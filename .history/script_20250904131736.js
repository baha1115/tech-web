...
confused.addEventListener('click',e=>{
  ...
  clicktl.to({onStart:()=>{
    ...
    confusedPage.background="url('/src/glitch1.png')"
  },duration:0.3})
  clicktl.to({onStart:()=>{
    
    confusedPage.background="url('/src/glitch2.png')"
  },duration:0.3})
  clicktl.to({onStart:()=>{

    confusedPage.background="url('/src/glitch3.png')"
  },duration:0.3})
  clicktl.to({onStart:()=>{
    
    confusedPage.background="url('/src/glitch4.png')"
  },duration:0.3})
