  ...
  clicktl
    ...
    .to(begining, {
      ...
      onComplete: () => {
        ...
        glitchanim() // نستدعي الأنيميشن متاع الغليتش
      }
    })
})
...
function glitchanim() {
  if (glitchtl) {
    glitchtl.restart() // لو موجود يعاود يخدم
    return
  }

  glitchtl = gsap.timeline({ repeat: -1 })

  glitchback.forEach(back => {
    glitchtl.to(confusedPage, {
