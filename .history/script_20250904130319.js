...
confused.addEventListener('click',e=>{
  ...
  onComplete: () => begining.style.display = 'none'
   ...
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch2.png')",duration:0.1
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch2.png')",duration:0.1
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch3.png')",duration:0.1
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch4.png')",duration:0.1
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch1.png')",duration:0.1
   })
   clicktl.to(confusedPage,{
    backgroundImage:"url('/src/glitch2.png')",duration:0.1
   })
