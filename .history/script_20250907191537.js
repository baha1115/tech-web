...
let tl = gsap.timeline({paused: true});
  ...
  const scroll=new LocomotiveScroll({
    el:
    document.querySelector('[data-scroll-container]'),smooth:4
  })
...
// دخول العناصر بتأثير سلس
gsap.from('.si',{
  scrollTrigger:{
    trigger:'.section2-part2',
    start:'top 80%',scrub:2,
    scroller: "[data-scroll-container]"
  },
  opacity:0,
  y:30,
